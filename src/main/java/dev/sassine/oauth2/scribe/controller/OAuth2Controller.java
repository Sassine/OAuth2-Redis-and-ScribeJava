package dev.sassine.oauth2.scribe.controller;
...
import dev.sassine.oauth2.scribe.factory.OAuth2ServiceFactory;
import dev.sassine.oauth2.scribe.provider.UserRedisProvider;
...
public class OAuth2Controller {
    ...
    private final UserRedisProvider userSession;
    ...
    public RedirectView oauth2Code(@PathVariable String serviceId, String code, String state) throws InterruptedException, ExecutionException, IOException {
        if (!Objects.equals(state, userSession.get(KEY_STATE))) {
            ...
            OAuth2ApiDTO oAuth2Api = (OAuth2ApiDTO)oAuth20Service.getApi();
